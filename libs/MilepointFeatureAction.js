  ...
  var clazz = declare(BaseFeatureAction, {
    ...
    onExecute: function(featureSet){
      ...
      .then(function(myWidget) {
        myWidget._featureAction = true;
        myWidget._deactivateSelectAllClick();
        myWidget._onSelectAllClick();
        var point = {
          "mapPoint": {
            "x": featureSet.features[0].geometry.x,
            "y": featureSet.features[0].geometry.y,
            "spatialReference": {
              "wkid": featureSet.spatialReference.wkid
            }
          }
        };
        myWidget._onMapClick(point);
      });
    }
